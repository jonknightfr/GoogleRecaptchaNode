...
-->
# Google reCAPTCHA Node

A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 5.5 and above. An authentication node which renders a Google reCAPTCHA widget requiring user input. Intended to help reduce automated/bot attacks.
